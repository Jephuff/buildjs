...
const depchek = require('../depcheck');
...
const getDependencyVersion = (dep, topDeps, localPkgs, modifiedPkgs, dir) => {
  ...
  if (modifiedPkgs.includes(dep)) return process.env.NEXT_VERSION;
...
findDeps(path.join(config.get('dir_packages'), '@ncigdc', 'webpack-config-buildjs-base'))
